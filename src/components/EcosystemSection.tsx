...
const EcosystemSection = () => {
  ...
  const modules = [
    {
      id: "core-platform",
      title: "Plataforma Due Diligence Automatizada",
      tagline: "El núcleo de nuestro ecosistema",
      description: "Plataforma central para automatizar el proceso de due diligence y generar Investment Memos profesionales mediante IA.",
      benefits: [
        "Procesamiento de múltiples formatos de documentos",
        "Extracción automática de entidades y métricas clave",
        "Consultas en lenguaje natural con citas a fuentes",
        "Generación de Investment Memos estructurados"
      ],
      icon: (
    ...
    {
      id: "thesis-alignment",
      title: "Análisis de Alineación con Tesis",
      tagline: "Evalúa compatibilidad con criterios de inversión",
      description: "Sistema avanzado que evalúa automáticamente la alineación de cada startup con los criterios específicos de la tesis de inversión de tu fondo.",
      benefits: [
        "Configuración personalizada de criterios de inversión",
        "Scoring automático de compatibilidad",
        "Detección de fortalezas y riesgos",
        "Visualización de alineación por criterios clave"
      ],
      icon: (
        <svg className="w-10 h-10" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      title: "Dashboard de Gestión de Portafolio",
      tagline: "Monitoreo integral de inversiones",
      description: "Analytics completo para monitorear el rendimiento de tu portafolio actual y pipeline de oportunidades con métricas clave y alertas.",
      benefits: [
        "Visualización centralizada de KPIs de portafolio",
        "Tracking de progreso de due diligence",
        "Análisis comparativo entre startups",
        "Alertas sobre hitos y eventos críticos"
      ],
      icon: (
        <svg className="w-10 h-10" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      id: "deal-analyzer",
      title: "Análisis Predictivo de Deals",
      tagline: "Anticípate a las oportunidades",
      description: "Sistema de análisis predictivo que identifica las startups con mayor potencial de éxito basado en patrones históricos de tu fondo.",
      benefits: [
        "Identificación de startups high-potential",
        "Comparación con casos de éxito previos",
        "Detección de patrones de crecimiento",
        "Alertas de oportunidades similares a éxitos anteriores"
      ],
      icon: (
        <svg className="w-10 h-10" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      title: "Biblioteca de Investment Memos",
      tagline: "Optimiza tu proceso de análisis",
      description: "Biblioteca de templates pre-diseñados para diferentes tipos de inversiones, sectores y etapas de startups.",
      benefits: [
        "Templates optimizados según sector y etapa",
        "Estructura adaptada a criterios específicos",
        "Diseños profesionales con identidad del fondo",
    ...
    {
      id: "integrations",
      title: "Integraciones con Sistemas de Inversión",
      tagline: "Conecta todo tu ecosistema de inversión",
      description: "Conecta InvestFlow con los sistemas que ya utilizas para mantener todo sincronizado y centralizado.",
      benefits: [
        "Integración con sistemas de gestión de deals",
        "Sincronización con bases de datos externas",
        "Exportación a múltiples formatos (PDF, PPT, DOCX)",
        "APIs para conexión con sistemas propietarios"
      ],
      icon: (
        <svg className="w-10 h-10" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M14 2H6C5.46957 2 4.96086 2.21071 4.58579 2.58579C4.21071 2.96086 4 3.46957 4 4V20C4 20.5304 4.21071 21.0391 4.58579 21.4142C4.96086 21.7893 5.46957 22 6 22H18C18.5304 22 19.0391 21.7893 19.4142 21.4142C19.7893 21.0391 20 20.5304 20 20V8L14 2Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    ...
    <section id="ecosystem" className="bg-gradient-to-b from-irrelevant-component/40 to-irrelevant-background py-24 relative overflow-hidden">
      ...
      <div className="section-container relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="mb-6">
            ...
            <span className="bg-gradient-to-r from-irrelevant-primary to-purple-400 text-transparent bg-clip-text"> proceso de inversión </span>
          </h2>
          <p className="max-w-2xl mx-auto text-irrelevant-textSecondary">
            InvestFlow no es solo una herramienta, es un ecosistema completo e integrado que potencia cada etapa del proceso de inversión, desde el análisis inicial hasta la gestión de portafolio.
          </p>
        </div>
          ...
          <div className="relative">
            ...
            <div className="w-32 h-32 bg-gradient-to-br from-irrelevant-primary/20 to-purple-500/20 rounded-full flex items-center justify-center mx-auto mb-12 border border-irrelevant-primary/30 z-10 relative">
              <div className="text-center">
                ...
                <span className="text-xs font-medium">ECOSISTEMA<br/>INVESTFLOW</span>
              </div>
            </div>
            ...
            <div className="p-8">
              ...
              {activeModule === 0 ? (
                ...
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="font-bold">Esta solución es un game changer para tu proceso de due diligence</h4>
                </div>
                <p className="text-irrelevant-textSecondary mb-4">
                  La plataforma de due diligence automatizada es la puerta de entrada al ecosistema completo de InvestFlow - un sistema integral que transforma cada etapa de tu proceso de inversión, desde el análisis inicial hasta la gestión del portafolio.
                </p>
              ...
              <div className="flex items-center justify-between mt-6 bg-irrelevant-background/30 rounded-lg p-4 border border-irrelevant-border/50">
                ...
                <a 
                  href="https://wa.me/573183351733?text=Quiero%20saber%20más%20sobre%20el%20ecosistema%20InvestFlow%20para%20mi%20fondo"
                  target="_blank"
      ...
      <div className="mt-12 text-center">
        <p className="text-lg max-w-3xl mx-auto text-irrelevant-textSecondary mb-6">
          Descubre cómo el ecosistema completo de InvestFlow puede transformar tu proceso de inversión, mejorando la calidad de tus decisiones y reduciendo drásticamente el tiempo dedicado al análisis
        </p>
        <a 
          href="https://wa.me/573183351733?text=Quiero%20conocer%20más%20del%20ecosistema%20completo%20InvestFlow%20para%20mi%20fondo%20de%20inversión"
          target="_blank"
          rel="noopener noreferrer"
