...
const UseCasesSection = () => {
  const [activeTab, setActiveTab] = useState("quote-tracking");
  
  const trackingCases = [
    {
      title: "Empresas B2B de servicios",
      description: "Ideal para consultoras, agencias y empresas que venden servicios profesionales donde el seguimiento personalizado marca la diferencia.",
      benefits: ["Insights de comportamiento del cliente", "Seguimiento automatizado"],
      icon: (
    ...
    {
      title: "Tiendas con productos personalizados",
      description: "Perfecto para empresas que venden productos configurables o personalizados, donde cada cotización es única y requiere seguimiento especial.",
      benefits: ["Reduce el ciclo de venta", "Detecta interés real"],
      icon: (
    ...
    {
      title: "Proyectos de alto valor",
      description: "Para constructoras, empresas de tecnología o cualquier negocio que maneja proyectos grandes donde cada propuesta debe ser monitoreada con precisión.",
      benefits: ["Priorización inteligente de leads", "Aumento de tasa de cierre"],
      icon: (
  ...
  const analyticsCases = [
    {
      title: "Equipos comerciales distribuidos",
      description: "Monitorea el rendimiento de tus equipos de ventas en diferentes ubicaciones, identificando qué propuestas funcionan mejor y cuáles necesitan ajustes.",
      benefits: ["Dashboard de rendimiento por equipo", "Detección de mejores prácticas"],
      icon: (
        <svg className="w-6 h-6 sm:w-8 sm:h-8 text-blue-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      title: "Optimización de propuestas",
      description: "Analiza qué secciones de tus cotizaciones generan más interés, permitiéndote refinar tu estrategia de ventas y mejorar tus tasas de conversión.",
      benefits: ["Mapa de calor de interacción", "Análisis de tiempo de lectura"],
      icon: (
        <svg className="w-6 h-6 sm:w-8 sm:h-8 text-indigo-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      description: "Conecta nuestro sistema con tu CRM existente para crear un flujo de trabajo completo, desde la generación de leads hasta el cierre de ventas.",
      benefits: ["Sincronización automática", "Vista unificada del cliente"],
      icon: (
        <svg className="w-6 h-6 sm:w-8 sm:h-8 text-purple-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <section id="use-cases" className="section-container py-12 sm:py-16 md:py-24 bg-gradient-to-b from-irrelevant-background to-irrelevant-background/90">
      <div className="text-center mb-8 sm:mb-12 md:mb-16 px-4">
        ...
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4 sm:mb-6">
          Solución para 
          <span className="bg-gradient-to-r from-irrelevant-primary to-purple-400 text-transparent bg-clip-text"> cada tipo </span>
          de negocio
        </h2>
        <p className="max-w-2xl mx-auto text-sm sm:text-base text-irrelevant-textSecondary">
          Irrelevant Quotes se adapta a diferentes escenarios comerciales, permitiéndote convertir más leads en clientes satisfechos.
        </p>
      </div>
        ...
        {activeTab === 'quote-tracking' ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 items-center">
            <div>
              <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-irrelevant-primary to-purple-400 text-transparent bg-clip-text">
                Sabe exactamente cuándo actuar
              </h3>
              <p className="text-xs sm:text-sm md:text-base text-irrelevant-textSecondary mb-4 sm:mb-6">
                Convierte tus propuestas en herramientas inteligentes que te dicen exactamente cuándo y cómo hacer seguimiento.
              </p>
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-bold mb-1 text-sm sm:text-base">Crea tu cotización</h4>
                    <p className="text-xs sm:text-sm text-irrelevant-textSecondary">Personalizada con el logo, nombre y detalles específicos</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-bold mb-1 text-sm sm:text-base">Compártela como una URL</h4>
                    <p className="text-xs sm:text-sm text-irrelevant-textSecondary">El cliente ve una landing profesional, no un PDF estático</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-bold mb-1 text-sm sm:text-base">Recibe alertas inteligentes</h4>
                    <p className="text-xs sm:text-sm text-irrelevant-textSecondary">Sabes exactamente cuándo el cliente muestra más interés</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="flex justify-center mt-6 md:mt-0">
              <div className="relative w-full max-w-xs">
                ...
                <img 
                  ...
                  alt="Seguimiento de cotizaciones" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 items-center">
            <div>
              ...
              <p className="text-xs sm:text-sm md:text-base text-irrelevant-textSecondary mb-4 sm:mb-6">
                Descubre exactamente qué partes de tu propuesta generan más interés y optimiza tu estrategia comercial con datos reales.
              </p>
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-irrelevant-primary/20 text-irrelevant-primary flex items-center justify-center mr-2 sm:mr-3 mt-0.5 text-xs sm:text-sm">1</div>
                  <div>
                    <h4 className="font-bold mb-1 text-sm sm:text-base">Monitoreo en tiempo real</h4>
                    <p className="text-xs sm:text-sm text-irrelevant-textSecondary">Ve cuántas veces y por cuánto tiempo ven tu propuesta</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-irrelevant-primary/20 text-irrelevant-primary flex items-center justify-center mr-2 sm:mr-3 mt-0.5 text-xs sm:text-sm">2</div>
                  <div>
                    <h4 className="font-bold mb-1 text-sm sm:text-base">Análisis de secciones</h4>
                    <p className="text-xs sm:text-sm text-irrelevant-textSecondary">Identifica qué partes de tu propuesta generan más interés</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-irrelevant-primary/20 text-irrelevant-primary flex items-center justify-center mr-2 sm:mr-3 mt-0.5 text-xs sm:text-sm">3</div>
                  <div>
                    <h4 className="font-bold mb-1 text-sm sm:text-base">Mejora continua</h4>
                    <p className="text-xs sm:text-sm text-irrelevant-textSecondary">Optimiza tus propuestas basándote en datos de comportamiento</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="px-4 sm:px-6">
        {activeTab === 'quote-tracking' ? renderCaseCards(trackingCases) : renderCaseCards(analyticsCases)}
      </div>
      
      <div className="text-center mt-8 sm:mt-12 md:mt-16 px-4">
        <a 
          href="https://wa.me/573183351733?text=Quiero%20implementar%20cotizaciones%20inteligentes%20en%20mi%20empresa"
          target="_blank"
