const Footer = () => {
  return (
    <footer className="bg-irrelevant-background border-t border-irrelevant-interactive py-16">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="md:col-span-4">
            ...
            <ul className="space-y-3">
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-irrelevant-primary mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:info@irrelevant.com" className="text-irrelevant-textSecondary hover:text-white transition-colors">jpgomez@irrelevant.com</a>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-irrelevant-primary mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:+5712345678" className="text-irrelevant-textSecondary hover:text-white transition-colors">+57 318 335 1733</a>
              </li>
        ...
        <div className="border-t border-irrelevant-interactive mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-irrelevant-textSecondary text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Irrelevant. Todos los derechos reservados.
          </p>
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-2">
            <a href="#" className="text-irrelevant-textSecondary hover:text-white text-sm">Términos de Servicio</a>
            <a href="#" className="text-irrelevant-textSecondary hover:text-white text-sm">Política de Privacidad</a>
          </div>
        </div>
      </div>
    </footer>
